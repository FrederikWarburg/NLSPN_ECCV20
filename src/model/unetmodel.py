...
class UNETModel(nn.Module):
    def __init__(self, args = None):
        ...
        # Decoder
        self.dec5_rgb = Upsample(1024, 512, 512, kernel=3, stride=2, padding=1, output_padding=1, upsampling=self.upsampling,aggregate=self.aggregate) # 1/16
    ...
    def forward(self, sample):
        ...
        bottleneck = self.conv6_rgb(fe5_rgb)
