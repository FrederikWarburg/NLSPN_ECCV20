...
parser.add_argument('--model_name',
                    type=str,
                    default='NLSPN',
                    choices=('UNET', 'PNCONV_RESNET18', 'GLOBALLOCAL', 'EARLYFUSION', 'GUIDEDRESNET18', 'RESNET18_UNET', 'NCONV_RESNET18UNET', 'NLSPN','NCONV_UNGUIDED','NCONV_GUIDED', 'NCONV_STREAM', 'NCONV_ENCDEC', 'PNCONV_UNGUIDED', 'RGB_UNET'),
                    help='model name')
